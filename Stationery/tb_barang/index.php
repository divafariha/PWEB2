...
<div class="container"><br>
  ...
  <p>
    <a href="../tb_pembeli/index.php"><button style="color: #fff; background: #7FB5FF; border: 3px; padding: 5px 8px;border-radius: 5px;">Tabel Pembeli</button></a>
    <a href="#"><button style="color: #fff; background: white; border: 3px; padding: 5px 10px;border-radius: 5px;"></button></a>
    <a href="../tb_barang/index.php"><button style="color: #fff; background: #7FB5FF; border: 3px; padding: 5px 8px;border-radius: 5px;">Tabel Barang</button></a>
  </p><br>
